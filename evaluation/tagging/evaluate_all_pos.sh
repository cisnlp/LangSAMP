...
OUTPUT_DIR="/mounts/data/proj/yihong/decoupled_training/evaluation/tagging/pos/"
tokenized_dir="/mounts/data/proj/yihong/decoupled_training/evaluation/tagging/pos_tokenized"
