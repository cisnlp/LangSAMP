...
from modeling_xlmr_decoupled import XLMRobertaDecoupledModel, XLMRobertaDecoupledForTokenClassification
import argparse
import glob
import logging
import os
...
def run(args):
    ...
    if not args.init_checkpoint:
        ...
        if args.init_checkpoint == 'cis-lmu/glot500-base':
            ...
            model = XLMRobertaDecoupledForTokenClassification.from_pretrained(args.init_checkpoint, config=config)
    print(model)
